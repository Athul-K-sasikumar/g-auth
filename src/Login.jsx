...
function App() {
  ...
  return (
    <MDBContainer className=" r2  my-5">
      <MDBCard className="shadow">
        <MDBRow className='g-0'>
          <MDBCol md='6'>
            <MDBCardImage 
              src='https://png.pngtree.com/thumb_back/fh260/background/20230718/pngtree-contemporary-authentic-3d-renderings-of-web-login-page-templates-image_3904126.jpg' 
              alt="login form" 
              className='r1 rounded-start' 
            />
          </MDBCol>
